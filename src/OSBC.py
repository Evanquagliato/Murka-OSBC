...
if __name__ == "__main__":
    ...
    #from model.osrs import OSRSMyBot # Uncomment this line and replace <folder_bot_is_in> and <bot_class_name> accordingly to import your bot
    app = App()  # Add the "test=True" argument to the App constructor call.
    app.start()  # Comment out this line.
    #app.test(OSRSMyBot())  # Uncomment this line and replace argument with your bot's instance.
